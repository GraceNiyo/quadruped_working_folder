...
base_data_dir = '../all_data/single_leg_experiment/single_leg_model/debugging_muscle_spindle/indipendent_drive'
            ...
            if current_sim_time_relative < cumulative_times[0]: # Phase 1: 0 to 2 seconds
                ...
                for m in range(model.nu): # Calculate Ia feedback using the spindle model
                    ...
                    Ia_feedback, II_feedback = gamma_driven_spindle_model_(
                        ...
                        gamma_dynamic= gamma_dynamic[m],
                        gamma_static= gamma_static[m]
                    )
                    Ia_a[m] = Ia_feedback
                    II_a[m] = II_feedback
